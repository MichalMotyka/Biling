...
public class LoginScreeen {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    LoginScreeen window = new LoginScreeen();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    if(log.isZalog(textField.getText().toString(),passwordField.getText().toString())) {
                        ...
                        JOptionPane.showMessageDialog(frame,"Hasło lub login jest nie prawidłowe proszę spróbować jeszcze raz");
                    }
